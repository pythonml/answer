...
if __name__ == "__main__":
    ...
    if args.save:
        topic_ids = [19570158, 19551432, 19550517, 19552430, 19555513, 19560891, 19555457, 19552488, 19612883, 19649905, 19555427, 19561726, 19560803, 19588006, 19562469, 19551771, 19571556, 19561382, 19551556]
